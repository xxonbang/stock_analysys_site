...
4. **펀더멘털 분석**: 종목별로 펀더멘털 지표(PER, PBR, PEG, ROE, OPM, EPS, 부채비율, 배당수익률 등)를 Google 검색하여 최신 수치를 확보하고, 밸류에이션(고평가/적정/저평가) 판단에 반영하십시오. 동종 업종 평균과 비교하여 상대적 위치를 평가하십시오. 검색된 수치는 출처와 함께 명시하십시오.
5. **향후 전망**: 과거 이력(${historicalPeriod}) 분석 결과, 현재 기술적 지표, 펀더멘털 분석을 종합하여 향후 전망 기간(${period}) 동안의 주가 전망을 제시하십시오.
6. **결론**: 향후 전망 기간(${period})에 맞는 투자 의견을 명확하게 제시하십시오. 과거 이력 분석 결과와 펀더멘털 분석을 근거로 제시하십시오.
7. **어조**: 전문적이고 신뢰감 있게, 그러나 개인 투자자가 이해하기 쉽게 설명하십시오.
...
## 수급 분석
## 펀더멘털 분석
  - 주요 지표 (PER, PBR, PEG, ROE, OPM, EPS, 부채비율, 배당수익률)
  - 밸류에이션 평가 (동종 업종 대비)
## 향후 전망 (${period} 기간)
  - 긍정적 시나리오
  - 부정적 시나리오
